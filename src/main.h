...
static const int LAST_POW_ONLY_BLOCK = 262800;	// estimated to be about 365 days
...
static const double TAXATION_PERCENTAGE = 0.10;
...
static const uint256 hashGenesisBlock("00000db8c156c2479011f4b44325fd4ca649882af54e3498f111e146d597f038");
static const uint256 hashGenesisBlockTestNet("00000db8c156c2479011f4b44325fd4ca649882af54e3498f111e146d597f038");
...
public:
    ...
    {
        // EqualCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // EqualCoin: get transaction coin age
...
public:
    ...
    // EqualCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // EqualCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // EqualCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // EqualCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // EqualCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // EqualCoin: block index flags
    enum  
    {
